  ...
  return (
    <div className="p-4 space-y-4">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold">Мои продажи</h2>
        <Button
          variant="outline"
          size="sm"
          onClick={handleSync}
      ...
      <div className="space-y-2">
        <h3 className="text-sm font-medium text-muted-foreground">Сегодня</h3>
            ...
            <CardContent className="p-4">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">{stats.today.quantity} шт</p>
                </div>
      ...
      {/* За неделю */}
      <div className="space-y-2">
        <h3 className="text-sm font-medium text-muted-foreground">За неделю</h3>
        <div className="grid grid-cols-2 gap-3">
          <Card>
            <CardContent className="p-4">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">{stats.week.quantity} шт</p>
                </div>
      ...
      {/* За месяц */}
      <div className="space-y-2">
        <h3 className="text-sm font-medium text-muted-foreground">За месяц</h3>
        <div className="grid grid-cols-2 gap-3">
          <Card>
            <CardContent className="p-4">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">{stats.month.quantity} шт</p>
                </div>
                <div className="bg-primary/10 p-2 rounded-lg">
                  <TrendingUp className="w-4 h-4 text-primary" />
                </div>
      ...
      <Card>
        <CardContent className="p-4">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm text-muted-foreground">Активные мотивации</p>
